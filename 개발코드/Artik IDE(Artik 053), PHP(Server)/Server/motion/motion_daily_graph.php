<?
    ...
    $arr_pos = 0;
    $arr_pos_check = 0;
    if(isset($_GET['daily_time']) && !empty($_GET['daily_time']) && isset($_GET['device_id'])){

      
      $device_id = $_GET['device_id'];
      $daily_time = $_GET['daily_time'];

        $sql = "SELECT * FROM motion_v01
                WHERE daily_time = '$daily_time' and device_id = '$device_id'
                ORDER BY motion_id";
