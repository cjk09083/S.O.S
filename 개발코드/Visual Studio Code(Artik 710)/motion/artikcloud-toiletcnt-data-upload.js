...
function sendSensorValueToArtikCloud(){
    try{
        ts = ', "ts": '+getTimeMillis();
        var toiletcnt = fs.readFileSync('/root/final/file/txt/motion/toiletcnt.txt');
        var toiletcntstring = toiletcnt.toString();
        var toiletcntstring10 = toiletcntstring.substring(0,0);
        var data = {
              "toiletcnt": toiletcntstring10
            };
